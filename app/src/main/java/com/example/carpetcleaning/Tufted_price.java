...
public class Tufted_price extends AppCompatActivity {
    EditText et,Address,Contact,Name;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tufted_price);
    ...
    public void Tufted_checkout(View view) {
        String tuftedCarpet=et.getEditableText().toString();
        ...
        Intent intent5=new Intent(this,Tufted_bill.class);
        intent5.putExtra("NUM",tuftedCarpet);
